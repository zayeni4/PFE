      ...
      <div className="bg-white dark:bg-neutral-950 py-10 px-6 border-b border-neutral-100 dark:border-neutral-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="w-32 h-32 bg-blue-50 dark:bg-blue-900/20 rounded-3xl flex items-center justify-center p-4 shrink-0 border border-blue-100 dark:border-blue-800">
            <img src={logo} alt="ISIMS Logo" className="w-full h-full object-contain" />
          </div>
      ...
      <div className="py-24 bg-white dark:bg-neutral-950">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { date: "25 Fév 2026", title: "Ouverture des candidatures pour les Mastères 2026/2027", desc: "Les étudiants intéressés peuvent désormais soumettre leurs dossiers en ligne via la plateforme dédiée.", tag: "Admission" },
              { date: "12 Mars 2026", title: "Séminaire sur l'Intelligence Artificielle Générative", desc: "Un événement exceptionnel réunissant des experts du domaine pour discuter des dernières avancées.", tag: "Événement" },
              { date: "05 Avr 2026", title: "Nouveau partenariat avec une université européenne", desc: "L'ISIMS renforce sa dimension internationale avec un nouvel accord de double diplôme.", tag: "Partenariat" },
            ].map((item, i) => (
              <motion.div key={i} whileHover={{ y: -10 }} className="group cursor-pointer">
                <div className="bg-neutral-50 dark:bg-neutral-900 rounded-2xl overflow-hidden border border-neutral-100 dark:border-neutral-800 transition-all shadow-sm hover:shadow-xl">
                  <div className="h-48 bg-neutral-200 dark:bg-neutral-800 relative">
                    <div className="absolute top-4 left-4 bg-blue-600 text-white text-[10px] font-bold px-2 py-1 rounded uppercase">{item.tag}</div>
                  </div>
                  <div className="p-6">
                    <div className="text-xs text-neutral-500 mb-2 font-bold">{item.date}</div>
                    <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-3 group-hover:text-blue-600 transition-colors">{item.title}</h3>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400 line-clamp-2">{item.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
              Nous offrons une expertise inégalée pour accompagner les étudiants et les professionnels.
            </p>
          </div>
...
const AppContent = () => {
  ...
  // ✅ Toutes les pages qui cachent la navbar
  const shouldHideNav =
